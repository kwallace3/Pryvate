...
//open and close form
            ...
            function reloadFormInfo() {
              ...
              var dateR = "<?php  if (isset($_SESSION['dateOfLesson'])) {
              echo $_SESSION['dateOfLesson'];}?>";
              lDate.value = dateR;

              var timeR = "<?php  if (isset($_SESSION['timeOfLesson'])) {
              echo $_SESSION['timeOfLesson'];}?>";
              lTime.value = timeR;

              var lenR = "<?php  if (isset($_SESSION['lenOfLesson'])) {
              echo $_SESSION['lenOfLesson'];}?>";
              lLen.value = lenR;

              var levelR = "<?php  if (isset($_SESSION['lessonLvl'])) {
              echo $_SESSION['lessonLvl'];}?>";
              lLevel.value = levelR;

              var instructorR = "<?php  if (isset($_SESSION['instructor'])) {
              echo $_SESSION['instructor'];}?>";
              lInstr.value = instructorR;

              var requR = "<?php  if (isset($_SESSION['requested'])) {
              echo 'checked=True';}?>";
              lRequ.value = requR;
